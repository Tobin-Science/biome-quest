...
// Serves a teacher-only protected file (Hall of Scientists leaderboard or
...
// =====================================================================
import { adminDb, BQ_BUCKET } from './_shared.js';
...
export async function GET(request) {
  try {
    ...
    const { data: file, error } = await db.storage.from(BQ_BUCKET).download(f.path);
